...
//  thirdDayweather(apikey,locationName)
 ...
 async function currentweather(locationName){
  ...
  function displaycurrent(nameOfCity="cairo",currentimg="images/113.png",textcurrent="clear",currenttemp="20",nameofday="monday",datestring="5 December" ){
       let cartona = "";
       cartona = `
                        ...
                        <h5 class="clear" >${textcurrent}</h5>
                         <div class="details d-flex  ">
                            <div class="percentage  me-4">
                                <img src="images/icon-umberella.png"/><span class="ms-2">20%</span>
                             </div>
                             <div class="percentage me-4">
                                <img src="images/icon-wind.png"/><span class="ms-2">18km/h</span>
                             </div>
                             <div class="percentage me-4">
                                <img src="images/icon-compass.png"/><span class="ms-2">East</span>
                             </div>
                         </div>
                     </div>
                </div>
...
// weather for 2 days 
 ...
 function displayforeast(nameoftomorrow="monday",tomorrowicon = "images/113 (1).png",maxtemp="20",mintemp="10", tomorrowtext="cloudy"){
     let cartona = '';
     cartona = `
...
function displaythird(nameofthird="monday",thirdicon= "images/113 (1).png",maxtemp="20",mintemp="10", thirdtext="cloudy"){
   let cartona = '';
   cartona = `
     <div class="inner  tomorrow   flex-grow-1  text-center">
                   <div class="titleofday  tomorrowday  text-center py-2 px-2">
